...
#if( ( ( ( defined __MS_VCXX__ ) || ( defined __CYGWIN_GCC__ ) || ( defined __LINUX_GCC__ ) ) && ( ( defined __X86__ ) || ( defined __X64__ ) ) ) || ( ( defined __ANDROID_GCC__ ) && ( defined __X64__ ) ) ) //Android x86下不能直接调用MemCpyAvx和MemCpySse2函数，因为MemCpy函数会获取GOT指针，而MemCpyAvx和MemCpySse2函数不会获取GOT指针。
