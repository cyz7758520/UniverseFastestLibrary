...
LOCAL_ARM_NEON := true
LOCAL_CFLAGS += -D__NAME_UNIVERSEFASTESTLIBRARY__ -D__ANDROID_NDK__ -D__ARMAT32__ -D__RELEASE__ -D__LNKDLL__ -D__COMDLL__
LOCAL_CPPFLAGS += 
else ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
#LOCAL_CFLAGS += -mfloat-abi=hard -mfpu=neon-fp-armv8
LOCAL_ARM_NEON := true
LOCAL_CFLAGS += -D__NAME_UNIVERSEFASTESTLIBRARY__ -D__ANDROID_NDK__ -D__ARMA64__ -D__RELEASE__ -D__LNKDLL__ -D__COMDLL__
LOCAL_CPPFLAGS += 
else ifeq ($(TARGET_ARCH_ABI),x86)
LOCAL_CFLAGS += -D__NAME_UNIVERSEFASTESTLIBRARY__ -D__ANDROID_NDK__ -D__X86__ -D__RELEASE__ -D__LNKDLL__ -D__COMDLL__
LOCAL_CPPFLAGS += 
else ifeq ($(TARGET_ARCH_ABI),x86_64)
LOCAL_CFLAGS += -D__NAME_UNIVERSEFASTESTLIBRARY__ -D__ANDROID_NDK__ -D__X64__ -D__RELEASE__ -D__LNKDLL__ -D__COMDLL__
LOCAL_CPPFLAGS += 
endif
